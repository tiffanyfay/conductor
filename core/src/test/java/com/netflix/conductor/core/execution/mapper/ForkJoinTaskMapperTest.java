...
public class ForkJoinTaskMapperTest {
    ...
    public void getMappedTasks() {
        ...
        assertEquals(TASK_TYPE_FORK, mappedTasks.getFirst().getTaskType());
    }
    ...
    public void getMappedTasksException() {
        ...
        assertTrue(exception.getMessage().contains("Fork task definition is not followed by a join task.  Check the blueprint"));
    }
}
