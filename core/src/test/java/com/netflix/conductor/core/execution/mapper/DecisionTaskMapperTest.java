...
class DecisionTaskMapperTest {
    ...
    @Test
    void getEvaluatedCaseValueException() {
        ...
        assertTrue(exception.getMessage().contains("Error while evaluating script: " + decisionTask.getCaseExpression()));
    }
}
